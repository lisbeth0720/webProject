<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="azerTagClassification.aspx.cs" Inherits="Web.Module.BankCall.azerTagClassification" %>
...
<body>
                ...
                <div class="func2BtnContent">
                    <ul>
                        ...
                        <li style=" position: relative;">
                            <img src="images/deleteBg.png" style="                                    position: absolute;
                                    left: 50%;
                                    top: 50%;
                                    transform: translate(-50%,-50%)"/>
    ...
    <script>
        ...
        var virCard="000000123456789123"
        ...
        $(function () {
            ...
            $(".submitCard").click(function () {
                if (checkIDCard($(".topFunc2 input[type=text]").val())) {
                    ...
                    timer = 15;
                    commonShadow("#topTripShadow", "温馨提示", "print1", 15, "");
                    ...
                    if (JSON.stringify(oldData) != JSON.stringify(thisData)) {
                        ...
                        for (var j = 0; j < Count.tbis.length; j++) {
                            ...
                            for (var i = 0; i < data.lv1data.length; i++) {
                                ...
                                enName = data.lv1data[i].tridata[0].m_d12;
                                str += "<li data-name='" + data.lv1data[i].triid + "' edata-name='" + data.lv1data[i].tridata[0].m_d12 + "' id='li_name' class='dataList' onmouseup='getCard(this)'><a><span >" + data.lv1data[i].triid + "</span><span class='enClassName'>" + enName+"</span></a></li>";
        ...
        function addNum(identType) {
            $.ajax({
                ...
                data: {
                    ...
                    $("#infoid span,#infoid a").css("color", "#fff");
                    if (identType == "1") {
        ...
        function getNumber() {
           ...
           $.ajax({
               ...
               url: "http://" + targetUrl+":8081/wpreadcard.asp",
                dataType: "html",
                data: {
                    "wpreadcard": "10",
                    "type": "6",
  ...
  /*----------------------------以下程序为打印与获取数据分开的方式-----------------------*/
    //1、判断打印机是否正常工作
        function getPrintStatus(cid) {
            ...
            $.ajax({
                type: "get",
                url: "http://" + sourceUrl + "/wpprintdata.asp",
                dataType: "html",
                data: {
                    "wpprintdata": "",
                    "utf8": "1",  //utf8=0表示返回utf8编码，=1表示gb2312
